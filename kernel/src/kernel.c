...
int main(int argc, char* argv[]) {
    ...
    log_info(logger_kernel, "Agregando 4 procesos de prueba adicionales a la cola de NEW... testeo");
    init_proc("testq", 1024);
    init_proc("testw", 1024);
    //init_proc("teste", 1024);
    //init_proc("testr", 1024);
